...
== Installation ==
1. Download the latest version of the plugin [here](https://github.com/magefan/wp-magefan-shopify-blog-export/releases).
2. Unzip the archive.
3. Ensure the unzipped folder name is `wp-magefan-shopify-blog-export`. Rename it if necessary.
4. Upload the `wp-magefan-shopify-blog-export` folder to the `/wp-content/plugins` directory in your WordPress installation.
